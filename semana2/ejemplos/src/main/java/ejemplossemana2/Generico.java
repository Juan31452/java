...
/**En su esencia, el término genéricos significa tipos 
 * parametrizados. Los tipos parametrizados son importantes 
 * porque le permiten crear clases, interfaces y métodos en 
 * los que el tipo de datos sobre los que operan se especifica 
 * como parámetro. 
 * Una clase, interfaz o método que funciona con un tipo de 
 * parámetro se denomina genérico, como una clase genérica o 
 * método genérico. */
