...
import co.edu.utp.misiontic2022.c2.vista.CalculadoraDivisionGUI;
import co.edu.utp.misiontic2022.c2.vista.CalculadoraMultiplicacionGUI;
import co.edu.utp.misiontic2022.c2.vista.CalculadoraResiduoGUI;
    ...
    public static void main(String[] args) {
        ...
        switch (tipo) {
            ...
            case MULTIPLICACION_GUI:
                view = new CalculadoraMultiplicacionGUI();
                break;
            case DIVISION_GUI:
                view = new CalculadoraDivisionGUI();
                break;
            case MODULO_GUI:
                // TODO: Implementar una vista para el módulo (resto de división)
                view = new CalculadoraResiduoGUI();
                break;
            default:
                return;
        }
